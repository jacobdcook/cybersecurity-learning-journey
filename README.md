...
* Status: Back to lab work after 2-month break - Section 11 complete, continuing with Security+ studies
...
### October - November 2025 (Getting Back on Track)

* Late October - Early November: Return to lab work after 2-month break
  * Section 11: Zero-day Vulnerabilities and Malware Analysis (First lab section completed in 2 months)
...
* Malware Analysis: Zero-day vulnerability research, system baseline analysis, virus/worm detection, spyware/bloatware identification, registry analysis
* Security Tools: Various security software and utilities, automated testing tools, Windows Defender, system information gathering
...
* [Detailed Lab Documentation](https://github.com/jacobdcook/security-plus-labs) - Maintained in separate repository (detailed lab procedures, screenshots, and technical documentation)
